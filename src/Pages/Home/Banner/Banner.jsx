               ...
               >
                    <SwiperSlide >
                         ...
                         <div className='text-center absolute -mt-[400px] '>
                              ...
                              <button className='btn btn-outline lg:-mr-[400px] border-b-4 btn-info uppercase text-white text-2xl font-semibold mt-5 '> Join Us  </button>
                         </div>
                    </SwiperSlide>
                    <SwiperSlide >
                         ...
                         <div className='text-center absolute -mt-[400px] '>
                              ...
                              <button className='btn  lg:-mr-[400px] border-b-4 btn-error text-white text-2xl font-semibold mt-5 '> Join Us  </button>
                         </div>
                    </SwiperSlide>
                    <SwiperSlide >
                         ...
                         <div className=' lg:ml-[100px] ml-[50px]  lg:w-3/5 mx-auto absolute -mt-[400px] '>
                              ...
                              <button className='btn   border-b-4 btn-info text-white text-2xl font-semibold mt-5 '> Join Us  </button>
                         </div>
                    </SwiperSlide>
