...
const Banner = () => {
     return (
          <div className=''>
               ...
               >
                    <SwiperSlide >
                         <img className=' h-[600px] relative opacity-100 w-full' src="https://i.ibb.co/1KFWWwb/organic-flat-feedback-concept-23-2148959061.jpg" alt="" />
                         <div className='text-center absolute -mt-[400px] '>
                              ...
                              <button className='btn btn-outline -mr-[400px] border-b-4 btn-success text-white text-2xl font-semibold mt-5 '> Join Us  </button>
                         </div>
                    </SwiperSlide>
                    <SwiperSlide >
                         <img className=' h-[600px] relative opacity-100 w-full' src="https://i.ibb.co/rQDjLHh/tiny-business-people-using-rating-site-vote-people-computer-screen-rating-site-professional-rank-sit.jpg" alt="" />
                         <div className='text-center absolute -mt-[400px] '>
                    ...
                    <SwiperSlide >
                         <img className=' h-[600px] relative opacity-100 w-full' src="https://i.ibb.co/1ZtqR9R/3d-illustration-hand-putting-tick-paper.jpg" alt="" />
