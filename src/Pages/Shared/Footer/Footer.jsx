                    ...
                    <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                         <div className="lg:w-1/3">
                              <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                                   <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-gray-700">
                                      <RiSurveyLine className="text-green-700 text-2xl font-bold"></RiSurveyLine>
                                   </div>
                                   <span className="self-center text-2xl text-green-700 font-semibold"> <span className="text-blue-700">Survey</span> Sense</span>
                              </a>
                         </div>
